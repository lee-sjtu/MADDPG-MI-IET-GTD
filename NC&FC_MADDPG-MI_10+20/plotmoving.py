...
def plotma(#max_tot_power, min_tot_power,
           ...
           agent_l1, agent_l2):#, agent_l2):#, agent_l3):#, agent_l4):#, agent_l5):


    plt.subplot(2, 4, 1)
    plt.plot(np.arange(len(agent_t1)), agent_t1)
    rt1mv = movingaverage(agent_t1, 100)
    ...
    rc1mv = movingaverage(agent_c1, 100)
