...
class World(object):
    ...
    def step(self, action_n, obs_n, soc_, t_stay_):
        # integrate physical state
        p_real, soc_, t_stay_ = self.integrate_agent_state(action_n, obs_n, soc_, t_stay_)  # update 1 station state 1 agent state
