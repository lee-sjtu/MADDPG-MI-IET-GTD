...
class QMIX:
    def __init__(self, args):
        ...
        if self.args.load_model:
            if os.path.exists(self.model_dir + '/power_li_rnn_net_params52.pkl'):
                path_rnn = self.model_dir + '/power_li_rnn_net_params52.pkl'
                path_qmix = self.model_dir + '/power_li_qmix_net_params52.pkl'
    ...
    def save_model(self):
        ...
        torch.save(self.eval_qmix_net.state_dict(), self.model_dir + '/' + 'power_li_qmix_net_params52.pkl')
        torch.save(self.eval_rnn.state_dict(),  self.model_dir + '/' + 'power_li_rnn_net_params52.pkl')
