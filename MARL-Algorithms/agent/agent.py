...
class Agents:
    ...
    def train(self, batch, train_step, time_steps, epsilon=None):  # coma needs epsilon for training
        # print(train_step)
...
class CommAgents:
    ...
    def train(self, batch, train_step, time_steps, epsilon=None):  # coma在训练时也需要epsilon计算动作的执行概率
